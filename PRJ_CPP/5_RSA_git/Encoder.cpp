...
unsigned_BigInt encoder(const string &X)
{
	unsigned_BigInt R = 0;
...
int main(int argc, char *argv[])
{
	...
	system("clear");
	cout << "**************************************************************" << endl;
	cout << "*                Digital Signature Encoder                   *" << endl;
	...
	if (argc > 1)
	{
		...
		else if (strcmp(argv[1], "--help") == 0)
		{
			...
			cout << "(2) Default input file are \"Alice_RSA_Private_Key\", \"Bob_RSA_Public_Key\"" << endl;
			cout << "(?) For help, please using --help" << endl;
			cout << "Wow!" << endl;
			return 0;
		}
	...
	cout << "Your digital signature for the receiver has been output to file \"Signature\"" << endl;
